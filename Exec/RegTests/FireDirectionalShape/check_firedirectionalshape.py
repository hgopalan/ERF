...
advective         erf.fire.directional_wind_coupling = "advective": phi_w
                  ...
                  Wulff shape
                  and the head runs at Rothermel's head rate, without imposing
                  an ellipse: back and flanks fall out of the same formula
                  (R0, since cos(theta) <= 0 there), rather than being set
                  separately as in the ellipse deck. Head, back and flanks at
                  the Hopf solution, and the head within 3 % of Rothermel's
                  head rate.
"""

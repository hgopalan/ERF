#!/usr/bin/env python3
"""Generate CSV for UCMMorphologyInjection test (Phase 2.6).
...
This isolates the morphology-driven alpha effect: alpha_ij = alpha_scale * H_mean.
Tall buildings should inject deeper into the atmosphere than short ones.
"""
import sys, os

#!/bin/bash
# Run the first-order, WENO5-Z, hybrid WENO5-Z/first-order and low near-front
# viscosity level-set decks and print the burned-cell
...
shift || true
for d in baseline weno5z weno5z_front lowvisc; do
...
for d in ("baseline", "weno5z", "weno5z_front", "lowvisc"):
    row = []

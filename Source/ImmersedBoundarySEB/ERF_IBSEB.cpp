                    ...
                    const MultiFab& xvel, const MultiFab& yvel, const MultiFab& zvel)
{
    ...
    Real z_i_bulk = 0.0;
    if (m_SurfaceLayer && ibseb_params.stability_correction && ibseb_params.stability_scheme == "iterative") {
        olen2d = m_SurfaceLayer->get_olen(lev);   // seed of the iteration; the Louis factors need none
    }
